...
INSERT INTO `categoria` VALUES (1,'Categoria 1','categoria-1'),(2,'Categoria 2','categoria-2'),(3,'categoria demo','categoria-demo'),(7,'Categoria otro plus','categoria-otro-plus'),(8,'Categoria plus','categoria-plus'),(10,'Categoria otro mas','categoria-otro-mas'),(11,'Categoria otro mas plus','categoria-otro-mas-plus');
...
INSERT INTO `category` VALUES (1,'Categoria 1','Categoria-1'),(2,'Categoria 2','Categoria-2'),(3,'Categoria 3','Categoria-3');
...
INSERT INTO `permissions` VALUES (3,'CREATE'),(2,'DELETE'),(4,'READ'),(5,'REFACTOR'),(1,'UPDATE');
...
CREATE TABLE `product` (
  ...
  CONSTRAINT `FK1mtsbur82frn64de7balymq9s` FOREIGN KEY (`category_id`) REFERENCES `category` (`idCategory`)
...
INSERT INTO `product` VALUES (200,10,1,1,'Product 1','Product-1'),(500,20,1,2,'Product 2','Product-2'),(300,30,2,3,'Product 3','Product-3'),(800,80,2,4,'Product 4','Product-4'),(700,70,3,5,'Product 5','Product-5'),(700,70,3,6,'Product 6','Product-6');
...
INSERT INTO `role_permission` VALUES (1,1),(2,1),(3,1),(4,1),(3,2),(4,2),(4,3),(1,4),(2,4),(3,4),(4,4),(5,4);
...
INSERT INTO `roles` VALUES (1,'ADMIN'),(2,'USER'),(3,'INVITED'),(4,'DEVELOPER');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-08-15 13:45:42',NULL),('diagnostics.include_raw','OFF','2024-08-15 13:45:42',NULL),('ps_thread_trx_info.max_length','65535','2024-08-15 13:45:42',NULL),('statement_performance_analyzer.limit','100','2024-08-15 13:45:42',NULL),('statement_performance_analyzer.view',NULL,'2024-08-15 13:45:42',NULL),('statement_truncate_len','64','2024-08-15 13:45:42',NULL);
...
-- Dump completed on 2024-08-26  9:41:20
